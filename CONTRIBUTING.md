...
Both [code](https://github.com/queen-raae/gatsby-theme-mui/blob/main/CONTRIBUTING.md#contribute-with-code) and [other types](https://github.com/queen-raae/gatsby-theme-mui/blob/main/CONTRIBUTING.md#contribute-in-other-ways) of contributions are welcome.

## Getting started

- Read our [Code of Conduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.
- Read the [README](README.md) to get an overview of the project.
- Browse the [issues](https://github.com/queen-raae/gatsby-theme-mui/issues) and [discussions](https://github.com/queen-raae/gatsby-theme-mui/discussions) already taking place to familiarize yourself with the state of the project.

## Contribute with code

You may either solve an exciting [issue](https://github.com/queen-raae/gatsby-theme-mui/issues), or create a new [issue](https://github.com/queen-raae/gatsby-theme-mui/issues/new).
